        ...
        <div className="mb-12 sm:mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center p-4 sm:p-6">
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-2">Fast Execution</h3>
              <p className="text-sm sm:text-base text-gray-600">Lightning-fast trade execution with real-time market data updates.</p>
            </div>
            <div className="text-center p-4 sm:p-6">
              <div className="bg-blue-500 w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-2">Secure Platform</h3>
              <p className="text-sm sm:text-base text-gray-600">Bank-grade security measures to protect your assets and data.</p>
            </div>
            <div className="text-center p-4 sm:p-6">
              <div className="bg-blue-500 w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm sm:text-base text-gray-600">Round-the-clock customer support to assist you with any queries.</p>
            </div>
          </div>
        </div>
