          ...
          <div className="space-y-6 sm:space-y-8">
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">
                Our team is here to help you with any questions or concerns you may have about our trading platform.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-600">+1 (587) 760-3364</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-600">123 Trading Street, New York, NY 10001</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 p-5 sm:p-6 rounded-lg">
              <h4 className="font-semibold mb-3 sm:mb-4">Office Hours</h4>
