...
const Privacy = () => {
  return (
    <div>
      <div>
        <p className="text-[24px] mb-4">Privacy policy</p>
        ...
        <h2>Interpretation and Definitions</h2> <h2>Interpretation</h2> The
        words of which the initial letter is capitalized have meanings defined
        under the following conditions. The following definitions shall have the
        same meaning regardless of whether they appear in singular or in plural.{" "}
        <br />
        <h2>Definitions</h2> For the purposes of this Privacy Policy: <br />
        <br />
        ...
        refers to LIVIKA LP, 6, Fern Road, Sandyford, Dublin, D18 FP8, Republic
        of Ireland. <br />
        <br />
        ...
        such as a computer, a cellphone or a digital tablet. <br />
        <br />
        ...
        <br />
        <br />
        <strong>Website</strong> refers to blocktrade.com, accessible from
        https://blocktrademine.com. <br />
        ...
        <h2>Types of Data Collected</h2> <h2>Personal Data</h2> While using Our
        ...
        <ul>
          ...
          <li>Country of residence / Address</li> <li>Usage Data</li>
        </ul>
        <h2>Usage Data</h2> Usage Data is collected automatically when using the
        Service. <br />
        <br />
        ...
        device. <br /> <h2>Tracking Technologies and Cookies</h2> We use Cookies
        and similar tracking technologies to track the activity on Our Service
        and store certain information. Tracking technologies used are beacons,
        tags, and scripts to collect and track information and to improve and
        analyze Our Service. The technologies We use may include: <br />
        <br />
        <ul>
          {" "}
          <li>
        ...
        <br />
        <br /> Purpose: These Cookies are essential to provide You with services
        ...
        <br /> Administered by: Us
        <br />
        <br /> Purpose: These Cookies identify if users have accepted the use of
        cookies on the Website. <br />
        <br />
        ...
        <h2>Use of Your Personal Data</h2> The Company may use Personal Data for
        ...
        <ul>
          ...
          <li>
            With law enforcements: we may disclose Your personal information
            with any law enforcements if we find it necessary to protect any
            person rights or to investigate, prevent any crime or breaching of
            rights of us or any third person.
          </li>
        </ul>
        <h2>Retention of Your Personal Data</h2> The Company will retain Your
        ...
        data for longer time periods. <br />
        <h2>Transfer of Your Personal Data</h2> Your information, including
        Personal Data, is processed at the Company&quot;s operating offices in
        the EU and in any other places where the parties involved in the
        ...
        <br />
        <h2>Disclosure of Your Personal Data</h2> Business Transactions
        ...
        <h2>Security of Your Personal Data</h2> The security of Your Personal
        ...
        <br /> <h2>Children&quot;s Privacy</h2> Our Service does not address
        anyone under the age of 18. We do not knowingly collect personally
        ...
        information. <br />{" "}
        <h2>Legal Basis for Processing Personal Data under GDPR</h2> We may
        process Personal Data under the following conditions: <br />
        <br /> Consent: You have given Your consent for processing Personal Data
        ...
        with a legal obligation to which the Company is subject. <br />
        <br />
        Vital interests: Processing Personal Data is necessary in order to
        protect Your vital interests or of another natural person. <br />
        <br />
        Public interests: Processing Personal Data is related to a task that is
        carried out in the public interest or in the exercise of official
        authority vested in the Company. <br />
        <br />
        Legitimate interests: Processing Personal Data is necessary for the
        purposes of the legitimate interests pursued by the Company. <br />
        <br />
        ...
        a requirement necessary to enter into a contract. <br />
        <h2>Your Rights under the GDPR</h2> The Company undertakes to respect
        the confidentiality of Your Personal Data and to guarantee You can
        exercise Your rights. <br />
        <br /> You have the right under this Privacy Policy, and by law, to:{" "}
        <br />
        <br />
        ...
        Your account settings section. <br />
        <br />
        If you are unable to perform these actions yourself, please contact Us
        to assist You. This also enables You to receive a copy of the Personal
        Data We hold about You. <br />
        <br />
        ...
        Personal Data for direct marketing purposes. <br />
        <br />
        Request erasure or deletion of Your Personal Data. You have the right to
        ask Us to delete or remove Personal Data when there is no good reason
        for Us to continue processing it. You may also contact Us to request
        access to, correct, or delete any personal information that You have
        provided to Us. To do it, you will be required to send an email to
        support@blocktrademine.com containing your full name and 4-digit security PIN
        code, which you set while account registration. Your request for
        deletion of personal data will be reviewed within legally regulated term
        and you will be notified of the outcome via your email. We can only
        comply with this request if we are not obliged to keep your data, or if
        the data is not necessary to provide services to you in conformity with
        the Terms and Conditions. <br />
        <br />
        Please note, however, that We may need to retain certain information
        when we have a legal obligation or lawful basis to do so. <br />
        <br />
        ...
        access to certain specific functionalities of the Service. You can
        withdraw Your consent only if any and all your obligation under the
        contract which is in force are fulfilled. <br />
        ...
        We will try our best to respond to You as soon as possible. <br />
        <br />
        ...
        protection authority in the EEA. <br /> <h2>Links to Other Websites</h2>
        ...
        <br />
        <h2>Changes to this Privacy Policy</h2> We may update Our Privacy Policy
